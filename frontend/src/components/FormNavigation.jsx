    ...
    <div className="flex items-center justify-between pt-8 mt-8 border-t border-stone-200">
      ...
      {isLastStep ? (
        <Button
          ...
          className="continue-button bg-terracotta hover:bg-terracotta/90 text-white rounded-full px-8 py-3 font-medium transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 flex items-center gap-2"
